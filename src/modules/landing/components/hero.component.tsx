import { FaChevronDown, FaEnvelope, FaGithub, FaLinkedinIn } from "react-icons/fa6"
import MyImage from "../../../assets/myImage.jpeg";
import Navbar from "./nav-bar.component"

export default function Hero({ className }: { className?: string }) {
  return (
    <div className = { `h-full w-full flex flex-col hero-scroll-animation ${ className }` }>
        ...
        <div className = "flex flex-col gap-10 sm:gap-14 p-5 sm:p-10 xl:p-5 pb-0 flex-shrink-0 xl:flex-grow xl:flex-row-reverse xl:justify-between xl:justify-self-center xl:box-border xl:pt-0 xl:gap-32 2xl:gap-5">
          ...
          <div className = "flex flex-col gap-4 sm:gap-8 xl:gap-6 justify-center 2xl:box-border 2xl:mx-20">
            ...
            <div className = "flex items-start justify-center xl:justify-normal mt-3 xl:mt-0">
              <a href="mailto:jenriquemflores@gmail.com" className = "dark-button rounded-full"><FaEnvelope size={18} /></a>
              <a href="https://www.linkedin.com/in/juanenriquemartinezflores/" target = "_blank" className = "dark-button rounded-full"><FaLinkedinIn size={18} /></a>
              <a href="https://github.com/Ju4nM" target = "_blank" className = "dark-button rounded-full"><FaGithub size={18} /></a>
